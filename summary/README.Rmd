...
# plot_volcano
#
# Helper function to generate an interactive volcano plot
#
plot_volcano <- function(dat, mtorc1_genes, mtorc2_genes, mtorc3_genes, title, data_type = "tx") {
  dat <- dat %>%
  ...
  dat$group <- ifelse(dat$symbol %in% shared_123, "mTORC1-3",
               ifelse(dat$symbol %in% shared_12, "mTORC1/2",
               ifelse(dat$symbol %in% shared_13, "mTORC1/3",
               ifelse(dat$symbol %in% shared_23, "mTORC2/3",
               ifelse(dat$symbol %in% mtorc1_unique, "mTORC1",
               ifelse(dat$symbol %in% mtorc2_unique, "mTORC2",
  ...
  names(pal) <- c("mTORC1", "mTORC3", "mTORC2", "mTORC1/2", "mTORC1/3", "mTORC2/3", "mTORC1-3", "Other")
